...
// ExecutionV1alpha1Client is used to interact with features provided by the execution.furiko.io group.
type ExecutionV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExecutionV1alpha1Client) Jobs(namespace string) JobInterface {
	return newJobs(c, namespace)
}

func (c *ExecutionV1alpha1Client) JobConfigs(namespace string) JobConfigInterface {
	return newJobConfigs(c, namespace)
}
...
// NewForConfigAndClient creates a new ExecutionV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ExecutionV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
