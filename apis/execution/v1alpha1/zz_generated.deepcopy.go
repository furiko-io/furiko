...
func (in *ArgoWorkflowTemplateSpec) DeepCopyInto(out *ArgoWorkflowTemplateSpec) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoWorkflowTemplateSpec.
func (in *ArgoWorkflowTemplateSpec) DeepCopy() *ArgoWorkflowTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(ArgoWorkflowTemplateSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *JobConfigSpec) DeepCopyInto(out *JobConfigSpec) {
	*out = *in
	...
	in.Concurrency.DeepCopyInto(&out.Concurrency)
	if in.Schedule != nil {
...
func (in *ParallelStatus) DeepCopyInto(out *ParallelStatus) {
	*out = *in
	in.ParallelStatusSummary.DeepCopyInto(&out.ParallelStatusSummary)
	if in.Indexes != nil {
		in, out := &in.Indexes, &out.Indexes
		*out = make([]ParallelIndexStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ParallelStatusCounters) DeepCopy() *ParallelStatusCounters {
	...
	out := new(ParallelStatusCounters)
	in.DeepCopyInto(out)
	return out
}
