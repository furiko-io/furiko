...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskParallelIndex) DeepCopyInto(out *TaskParallelIndex) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskParallelIndex.
func (in *TaskParallelIndex) DeepCopy() *TaskParallelIndex {
	if in == nil {
		return nil
	}
	out := new(TaskParallelIndex)
	in.DeepCopyInto(out)
	return out
}
