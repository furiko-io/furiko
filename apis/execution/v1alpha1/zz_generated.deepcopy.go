...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in CronExpressionList) DeepCopyInto(out *CronExpressionList) {
	{
		in := &in
		*out = make(CronExpressionList, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CronExpressionList.
func (in CronExpressionList) DeepCopy() CronExpressionList {
	if in == nil {
		return nil
	}
	out := new(CronExpressionList)
	in.DeepCopyInto(out)
	return *out
}
